...
function rowHtml(s) {
  ...
  const macdCross = s.indicators?.macd?.state;
  if (macdCross === "golden_cross") tags.push('<span class="tag">MACD轉強</span>');
  if (macdCross === "death_cross") tags.push('<span class="tag">MACD轉弱</span>');
